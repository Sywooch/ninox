...
class HistorySearch extends History{
    ...
    public $nakladnaStatus;

    public $actualAmountStatus;

    public $showDeleted = null;

    public function attributeLabels()
    {
        return array_merge(parent::attributeLabels(), [
            'moneyConfirmed'    =>  'Оплата',
            'nakladnaStatus'    =>  'Накладная',
            'status'            =>  'Статус заказа',
            'actualAmountStatus'=>  'Факт. сумма',
            'paymentType'       =>  'Тип оплаты',
            'showDeleted'       =>  'Удалённые'
    ...
    public function search($params, $onlyQuery = false, array $ignoreFilters = []){
        ...
        if(array_key_exists('paymentType', $params) && empty($params['paymentType'])){
            $ignoreFilters['paymentType'] = true;
        }
        ...
        $this->addCondition($query, 'moneyConfirmed');
        ...
        if(!array_key_exists('paymentType', $ignoreFilters)){
            $this->addCondition($query, 'paymentType');
        }
