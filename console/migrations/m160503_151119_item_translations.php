...
class m160503_151119_item_translations extends Migration
{
    public function up()
    {
        $this->createTable('item_translations',[
            ...
            'description'           =>  Schema::TYPE_TEXT.' CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT \'\'',
        ...
        $this->alterColumn('goods', 'Description', Schema::TYPE_TEXT.' CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT \'\'');
        $this->alterColumn('goods_uk', 'Description', Schema::TYPE_TEXT.' CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT \'\'');
        $this->alterColumn('goods_be', 'Description', Schema::TYPE_TEXT.' CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT \'\'');
