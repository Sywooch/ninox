...
class m151209_151332_cancels_a_global_catastrophe extends Migration
{
    public function up()
    {
        ...
        $this->alterColumn('partnersAddresses', 'partnerID', Schema::TYPE_BIGINT);
        ...
        $this->alterColumn('partnersContacts', 'partnerID', Schema::TYPE_BIGINT.'(16) DEFAULT NULL');
        $this->alterColumn('partnersContacts', 'ID', Schema::TYPE_BIGINT);
