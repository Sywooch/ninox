...
echo Html::tag('span', $good->Code, ['class' => 'item-id']),
    ...
    Html::tag('div', Html::tag('span', Formatter::getFormattedPrice($good->wholesale_price), ['class' => 'wholesale-price semi-bold']).
        Html::tag('span', Formatter::getFormattedPrice($good->retail_price), ['class' => 'retail-price']).
